...
<!-- Work in discussion on validity. If you are changing the example in the chapter, do that first -->
<!-- Deepen discussion of whether structure of our model --- linear regression, CART --- match the world. -->
<!-- Discussion of unknown unknowns esp when talking about extrapolating data to 2020 -->
...
Making out-of-sample predictions is a great way of measuring unknown unknowns in the world, which is data we haven't observed yet. When making such predictions, it is important to make sure that the conditions used to create the model match the conditions of the world you are extrapolating about. Using 1976--2018 election results to predict election results in 2020, we contend, is a pretty safe extrapolation. An unsafe extrapolation would be using UK election results to predict outcomes in the US. 
