...
cces_ch12 <- ccess %>%
  mutate(pres_approval = casewhen(
    approval_ch = "Strongly Approve" ~ 1,
    approval_ch = "Approve / Somewhat Approve" ~ 1,
    approval_ch = "Disapprove / Somewhat Disapprove" ~ 0,
    approval_ch = "Strongly Approve" ~ 1,
    approval_ch = "Neither Approve Nor Disapprove" ~ NA_character_,
    approval_ch = "Never Heard / Not Sure" ~ NA_character_
  ))
