...
When the individual is a Republican ($x_r$=0), their fitted value is 41.16. When the individual is a Democrat ($x_d$=0), their fiited value is 42.6. 
...
The *fitted value* of att_end was 8.4 for the control group and 10 for the treated group. 
