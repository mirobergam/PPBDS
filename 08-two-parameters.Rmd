...
The rows in this Rubin Table represent the 115 commuters for whom data was gathered and the remainder of the (roughly) 10,000 commuters that our model is extrapolating on. The purpose of a Rubin Table is to capture all of the data such that if the question marks were filled out, one wouldn't need to construct a model.
