...
Now, we'll create a RCM table of possible outcomes, as we did back in ch3. We'll do this using 7 random observations from the trains dataset. 
...
trains_RCM$subject <- c("4", "5,051", "76", "80,050", "578", "23", "9,088")
...
tibble(subject = c("4", "5,051", "76", "80,050", "578", "23", "9,088"),
